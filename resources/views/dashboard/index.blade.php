                                    ...
                                    <table class="table table-hover table-outline m-b-0 hidden-sm-down">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        <img src="{{asset('adminassetes/img/avatars/2.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{asset('adminassetes/img/avatars/2.jpg')}}">
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        <img src="{{asset('adminassetes/img/avatars/3.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{asset('adminassetes/img/avatars/3.jpg')}}">
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        <img src="{{asset('adminassetes/img/avatars/4.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{asset('adminassetes/img/avatars/4.jpg')}}">
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        <img src="{{asset('adminassetes/img/avatars/5.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{asset('adminassetes/img/avatars/5.jpg')}}">
                                                        <span class="avatar-status tag-success"></span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        <img src="{{asset('adminassetes/img/avatars/6.jpg')}}" class="img-avatar" alt="admin@bootstrapmaster.com" src="{{asset('adminassetes/img/avatars/6.jpg')}}">
                                                        <span class="avatar-status tag-danger"></span>
                                                    </div>
                                                </td>
                                                <td>
