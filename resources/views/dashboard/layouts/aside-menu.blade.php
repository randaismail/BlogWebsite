        ...
        <div class="tab-pane active" id="timeline" role="tabpanel">
            ...
            <div class="callout callout-warning m-a-0 p-y-1">
                <div class="avatar pull-xs-right">
                    <img src="{{asset('adminassetes/img/avatars/7.jpg')}}" class="img-avatar" alt="{{ auth()->user()->name }}">
                </div>
                <div>Meeting with
                    <strong>Lucas</strong>
                </div>
            ...
            <div class="callout callout-info m-a-0 p-y-1">
                <div class="avatar pull-xs-right">
                    <img src="{{asset('adminassetes/img/avatars/4.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                </div>
                <div>Skype with
                    <strong>Megan</strong>
                </div>
            ...
            <div class="callout callout-danger m-a-0 p-y-1">
                ...
                <div class="avatars-stack m-t-h">
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/2.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/3.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/4.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/5.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/6.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                </div>
            </div>
            <hr class="m-x-1 m-y-0">
            ...
            <div class="callout callout-primary m-a-0 p-y-1">
                ...
                <div class="avatars-stack m-t-h">
                    ...
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/7.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                    <div class="avatar avatar-xs">
                        <img src="{{asset('adminassetes/img/avatars/8.jpg')}}" class="img-avatar" alt="{{ auth()->user()->email}}">
                    </div>
                </div>
            </div>
            <hr class="m-x-1 m-y-0">
